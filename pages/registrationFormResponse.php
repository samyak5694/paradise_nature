...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <div id="welcome">
        <h5>Welcome!<br><span id='datetime'>It's Wednesday, April 8th.<br>Our time is 5:28pm.</span></h5><a class='LongerButton'
...
<!-- menus.html -->
    ...
    <main>
      <article class="Registration">
        <h3>Thank you for registering with our e-store.</h3><h3>To log in and start shopping please
         <a href='pages/loginForm.php'
            class='NoDecoration'>click here</a>.</h3>      </article>
    </main>
    <footer>
      <!-- footer_content.html -->
